...
namespace ldlidar {
    ...
    public:
        ...
        [[nodiscard]] bool IsPkgReady() const {
            return mIsPkgReady;
        } /*a packet is ready */
        ...
        [[nodiscard]] int32_t GetErrorTimes() const {
            return mErrorTimes;
        } /*the number of errors in parser process of lidar data frame*/
        const std::array<PointData, POINT_PER_PACK>& GetPkgData(); /*original data package*/
